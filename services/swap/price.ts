...
//   try {
//     const response = await client.query.compute.queryContractPrivateState(swapAddress, {
...
//   try {
//     const query = await client.query.compute.queryContractPrivateState(swapAddress, {
...
//     return await client.query.compute.queryContractPrivateState( {contractAddress :swapAddress, codeHash:   {
//       info: {},
//     })
//   } catch (e) {
