...
RUN ["hermes", "keys", "add", "--hd-path", "m/44'/118'/0'/0/0", "--mnemonic-file", "/home/hermes-user/d.mnemonic", "--chain", "trstdev-1"]
RUN ["hermes", "keys", "add", "--hd-path", "m/44'/118'/0'/0/0", "--mnemonic-file", "/home/hermes-user/d.mnemonic", "--chain", "trstdev-2"]

# add alternative key
COPY ["./c.mnemonic", "/home/hermes-user/c.mnemonic"]
RUN ["hermes", "keys", "add", "--hd-path", "m/44'/118'/0'/0/0", "--mnemonic-file", "/home/hermes-user/c.mnemonic", "--chain", "trstdev-1", "--key-name", "local1-alt"]
RUN ["hermes", "keys", "add", "--hd-path", "m/44'/118'/0'/0/0", "--mnemonic-file", "/home/hermes-user/c.mnemonic", "--chain", "trstdev-2", "--key-name", "local2-alt"]
