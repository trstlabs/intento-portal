                      ...
                      <CardContent style={{ padding: '2rem' }}>
                        ...
                        <div style={styles.statCard}>
                          ...
                          <Text variant="caption" css={{ color: '#a0aec0', marginBottom: '1rem', display: 'block' }}>
                            Complete the actions below to unlock your total claimable amount of {totalClaimable} INTO. Each completed action rewards you with {perActionReward} INTO. For each action, 20% is added to your balance immediately, and the remainder vests over several days. Stake 67%+ of the tokens you receive to claim vested tokens.
                          </Text>
